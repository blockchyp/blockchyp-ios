...
@interface SlideShowsTest : BlockChypTest
...
- (void)setUp {
  ...
  XCTestExpectation *expectation = [self expectationWithDescription:@"SlideShows Test Setup"];
...
- (void)testSlideShows{
  ...
  XCTestExpectation *expectation = [self expectationWithDescription:@"SlideShows Test"];
