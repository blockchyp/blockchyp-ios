...
@interface MerchantProfileTest : BlockChypTest



@end

@implementation MerchantProfileTest
...
- (void)setUp {
  ...
  [self testDelayWith:client testName:@"MerchantProfileTest"];
