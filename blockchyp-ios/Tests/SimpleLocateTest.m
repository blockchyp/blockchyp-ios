...
@interface SimpleLocateTest : BlockChypTest



@end

@implementation SimpleLocateTest
...
- (void)testSimpleLocate{
  ...
  XCTestExpectation *expectation = [self expectationWithDescription:@"SimpleLocate Test"];
