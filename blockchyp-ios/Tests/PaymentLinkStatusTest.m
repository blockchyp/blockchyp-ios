...
@interface PaymentLinkStatusTest : BlockChypTest
...
@implementation PaymentLinkStatusTest
...
- (void)setUp {
  ...
  XCTestExpectation *expectation = [self expectationWithDescription:@"PaymentLinkStatus Test Setup"];
