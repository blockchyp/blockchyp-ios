...
@interface EmptyBrandingAssetTest : BlockChypTest



@end

@implementation EmptyBrandingAssetTest
...
- (void)testEmptyBrandingAsset{
  ...
  XCTestExpectation *expectation = [self expectationWithDescription:@"EmptyBrandingAsset Test"];
