...
@interface UpdateTokenTest : BlockChypTest
...
@implementation UpdateTokenTest
...
- (void)setUp {
  ...
  XCTestExpectation *expectation = [self expectationWithDescription:@"UpdateToken Test Setup"];
...
- (void)testUpdateToken{
  ...
  XCTestExpectation *expectation = [self expectationWithDescription:@"UpdateToken Test"];
