...
@interface BatchHistoryTest : BlockChypTest
...
@implementation BatchHistoryTest
...
- (void)setUp {
  ...
  [self testDelayWith:client testName:@"BatchHistoryTest"];


  XCTestExpectation *expectation = [self expectationWithDescription:@"BatchHistory Test Setup"];
...
- (void)testBatchHistory{
  ...
  XCTestExpectation *expectation = [self expectationWithDescription:@"BatchHistory Test"];
